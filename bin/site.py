...
if __name__ == "__main__":
    ...
    # grab arguments
    parser = argparse.ArgumentParser(description="Generates risksdrivers.io site", epilog="""
    This tool converts all risksdrivers.io yamls and builds the site with all the supporting components.""")
    parser.add_argument("-p", "--path", required=False, default="yaml", help="path to loldriver yaml folder. Defaults to `yaml`")
    parser.add_argument("-o", "--output", required=False, default="risksdrivers.io", help="path to the output directory for the site, defaults to `risksdrivers.io`")
